...
third-party/mozart/mpp_core/CMakeFiles/mpp_core-test-event.dir/tests/test-event.cpp.obj: ../third-party/mozart/mpp_core/tests/test-event.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=C:\CPP\pro\cmake-build-debug\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object third-party/mozart/mpp_core/CMakeFiles/mpp_core-test-event.dir/tests/test-event.cpp.obj"
	cd /d C:\CPP\pro\cmake-build-debug\third-party\mozart\mpp_core && C:\BC\C\mingw64\bin\g++.exe  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles\mpp_core-test-event.dir\tests\test-event.cpp.obj -c C:\CPP\pro\third-party\mozart\mpp_core\tests\test-event.cpp
...
third-party/mozart/mpp_core/CMakeFiles/mpp_core-test-event.dir/tests/test-event.cpp.i: cmake_force
	...
	cd /d C:\CPP\pro\cmake-build-debug\third-party\mozart\mpp_core && C:\BC\C\mingw64\bin\g++.exe $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E C:\CPP\pro\third-party\mozart\mpp_core\tests\test-event.cpp > CMakeFiles\mpp_core-test-event.dir\tests\test-event.cpp.i
...
third-party/mozart/mpp_core/CMakeFiles/mpp_core-test-event.dir/tests/test-event.cpp.s: cmake_force
	...
	cd /d C:\CPP\pro\cmake-build-debug\third-party\mozart\mpp_core && C:\BC\C\mingw64\bin\g++.exe $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S C:\CPP\pro\third-party\mozart\mpp_core\tests\test-event.cpp -o CMakeFiles\mpp_core-test-event.dir\tests\test-event.cpp.s
...
third-party/mozart/mpp_core/mpp_core-test-event.exe: third-party/mozart/mpp_core/CMakeFiles/mpp_core-test-event.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=C:\CPP\pro\cmake-build-debug\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable mpp_core-test-event.exe"
	cd /d C:\CPP\pro\cmake-build-debug\third-party\mozart\mpp_core && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\mpp_core-test-event.dir\link.txt --verbose=$(VERBOSE)
...
third-party/mozart/mpp_core/CMakeFiles/mpp_core-test-event.dir/clean:
	cd /d C:\CPP\pro\cmake-build-debug\third-party\mozart\mpp_core && $(CMAKE_COMMAND) -P CMakeFiles\mpp_core-test-event.dir\cmake_clean.cmake
...
third-party/mozart/mpp_core/CMakeFiles/mpp_core-test-event.dir/depend:
	$(CMAKE_COMMAND) -E cmake_depends "MinGW Makefiles" C:\CPP\pro C:\CPP\pro\third-party\mozart\mpp_core C:\CPP\pro\cmake-build-debug C:\CPP\pro\cmake-build-debug\third-party\mozart\mpp_core C:\CPP\pro\cmake-build-debug\third-party\mozart\mpp_core\CMakeFiles\mpp_core-test-event.dir\DependInfo.cmake --color=$(COLOR)
